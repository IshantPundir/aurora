...
smithay::delegate_fifo!(@<BackendData: Backend + 'static> AuroraState<BackendData>);

smithay::delegate_commit_timing!(@<BackendData: Backend + 'static> AuroraState<BackendData>);
